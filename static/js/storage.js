...
/**
 * Carga datos de prueba en el almacenamiento
 */
function cargarDatosDePrueba() {
  ...
  fechaAnterior.setMonth(hoy.getMonth() - 1);
  ...
  const proveedores = [
    {
      id: "prov1",
      nombre: "Aceros Industriales S.A.",
      direccion: "Av. Industrial #123, Zona Industrial, Ciudad de México",
      tieneConstancia: true,
      constanciaUrl: "../uploads/constancias/constancia_aceros.pdf",
      ...
      contratos: [
        {
          ...
          fechaFin: tresMeses.toISOString().slice(0, 10),
          monto: 150000,
          documentoUrl: "../uploads/contratos/contrato_aceros_2023.pdf",
    ...
    {
      id: "prov2",
      nombre: "Suministros Técnicos del Norte",
      direccion: "Calle Reforma #456, Monterrey, Nuevo León",
      tieneConstancia: false,
      fechaRegistro: fechaAnterior.toISOString(),
      contratos: [
        {
          id: "cont2",
          numero: "CONT-2023-002",
          fechaInicio: fechaAnterior.toISOString().slice(0, 10),
          fechaFin: quinceDias.toISOString().slice(0, 10),
          monto: 75000,
          documentoUrl: "../uploads/contratos/contrato_suministros_2023.pdf",
          fechaCreacion: fechaAnterior.toISOString()
        }
      ]
    },
    {
      id: "prov3",
      nombre: "Distribuidora Eléctrica del Centro",
      direccion: "Blvd. Tecnológico #789, Guadalajara, Jalisco",
      tieneConstancia: true,
      constanciaUrl: "../uploads/constancias/constancia_electrica.pdf",
      fechaRegistro: fechaAnterior.toISOString(),
      contratos: [
        {
          id: "cont3",
          numero: "CONT-2022-015",
          fechaInicio: new Date(hoy.getFullYear() - 1, 0, 15).toISOString().slice(0, 10),
          fechaFin: new Date(hoy.getFullYear(), 0, 14).toISOString().slice(0, 10),
          monto: 200000,
          documentoUrl: "../uploads/contratos/contrato_electrica_2022.pdf",
          fechaCreacion: new Date(hoy.getFullYear() - 1, 0, 15).toISOString()
        }
      ]
    },
    {
      ...
      direccion: "Calzada del Valle #234, San Pedro Garza García, Nuevo León",
      tieneConstancia: true,
      constanciaUrl: "../uploads/constancias/constancia_logistica.pdf",
      fechaRegistro: hoy.toISOString(),
      contratos: []
    }
  ];
